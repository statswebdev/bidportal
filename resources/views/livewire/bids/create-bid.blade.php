                        ...
                        <form wire:submit.prevent="submitBid" class="row">
                            ...
                            <div class="mb-3 col-12 col-md-6">
                                ...
                                <div class="rounded-2 min-h-0">
                                    <input type="file" id="iulaanpdf" class="form-control" wire:model.lazy="iulaan_pdf" />
                                </div>
                                @error('iulaan_pdf')
                                    <div class="invalid-feedback d-flex">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3 col-12 col-md-6">
                                ...
                                <div class="rounded-2 min-h-0">
                                    <input type="file" id="infopdf" class="form-control" wire:model.lazy="info_sheet_pdf" />
                                </div>
                            ...
                            <div class="mb-3 col-12 col-md-6">
                                ...
                                <div class="rounded-2 min-h-0">
                                    <input type="file" id="specpdf" class="form-control" wire:model.lazy="spec_sheet_pdf" />
                            ...
                            <div class="mb-3 col-12 col-md-6">
                                ...
                                <div class="rounded-2 min-h-0">
                                    <input type="file" id="supportingpdf" class="form-control" wire:model.lazy="supporting_docs" />
